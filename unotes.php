...
<body itemscope itemtype="http://schema.org/AboutPage">
	<div id="page" class="site">
		...
		<section class="team-members" itemprop="contributor">
			<div class="container">
				<h2 class="top-heading">SYLLABUS DOWNLOAD FOR UG </h2>
				<article class="developer-grid">
				
				
				  <?php
$result=mysql_query("Select * from tb_note  where cat='UG' ");
	...
	while ($row = mysql_fetch_array($result))
		...
		$im=$row[file];
		  ?>
					...
					<div class="developer-wrap"  style="height:120px">
					<br><br>
					  <?php echo "<a href=admin/home/$im style='padding:35px; background:#0099FF; color:#FFFFFF ;font-size:28px' >SYLLABUS</a>";?></td>
