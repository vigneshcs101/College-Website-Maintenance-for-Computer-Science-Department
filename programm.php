			...
			<div class="container">
				<article class="who-we-are">
					...
					<tr style="font-size:16px; color:#FFFFFF; font-weight:bold; text-transform:uppercase; background:#0066FF">
					 <td>UG Programmes Offered</td></tr>
				
					<?php
$result=mysql_query("Select * from tb_course where cat='UG' ");
	...
	?>				</table>
	 ...
	 <table border="0">
					...
					<tr style="font-size:16px; color:#FFFFFF; font-weight:bold; text-transform:uppercase; background:#0066FF">
					 <td>PG Programmes Offered</td></tr>
				
					<?php
$result=mysql_query("Select * from tb_course where cat='PG' ");
	...
	?>				</table>
			...
			<table border="0">
					...
					<tr style="font-size:16px; color:#FFFFFF; font-weight:bold; text-transform:uppercase; background:#0066FF">
					 <td>Ph.D Programmes Offered</td></tr>
				
					<?php
$result=mysql_query("Select * from tb_course where cat='PhD' ");
