	...
	<div id="page" class="site">
	 ...
	 <Center>
		...
		<br>
				 ...
				 <div style="float:right" ><a href="enddetails.php" style="padding:10px; background:#006699; color:#FFFFFF; font-size:16px">ENDOWMENT LECTURE</a></div>
				 <br>		
        ...
        <th>PURPOSE AND ACTIVITES</th>   				 
          ...
          <?php
$result=mysql_query("Select * from tb_mou ");
