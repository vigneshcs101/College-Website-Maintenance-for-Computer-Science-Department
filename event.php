	...
	<div id="page" class="site">
		...
		<section class="team-members" itemprop="contributor">
			<div class="container">
				...
				<h1 style="font-size:20px; font-size:26px">Workshops / Conferences / Seminar organized</h1>
				<br>
 
 <p style="text-align:justify; color:#000000; font-size:16px">
Apart from regular Computer Science Association Activities, the Department has organized the following events in the past few years <br>
     One day Workshop on Android and Multimedia was organized by the Department of Computer Science on 12-10-2012. <br>
    One Day Seminar on �You can be On your Own� Recent Trends in Graphic Designing Advertising and Branding was organized by the Department of Computer Science on 28-02-2013.<br>
    A One Day Workshop on Soft Skill was conducted by the Department of Computer Science on 25-09-2009.<br>
    A Special Programme entitled NACOTECH 2010 was conducted by the Department of Computer Science on 15-02-2010. Inter Collegiate competitions on Computer related topics were conducted during the Programme.
</p>
				...
				<article class="developer-grid">
				  ...
				  <?php
$result=mysql_query("Select * from tb_event ");
	...
	while ($row = mysql_fetch_array($result))
		  ...
		  ?>
					...
					<img src="admin/home/<?php echo $im;?>"  alt="developer images">
