	...
	<div id="page" class="site">
		...
		<Center>
			<div class="container" >
					...
					<Table border="0">
					<tr>
					<td><h2 class="top-heading"><center>E CONTENT</h2><br>
					</td>
					</tr>
					<tr>
					<td>
					...
					<a href="home/lessonwrittennotes.pdf" style="padding:15px; background:#0099FF; color:#FFFFFF ;font-size:28px"  >CONTENT1</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					
				 <a href="home/1,2,3 lesson VB.pdf" style="padding:15px; background:#0099FF; color:#FFFFFF ;font-size:28px">CONTENT2</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 	 <a href="home/DSA (1).pdf" style="padding:15px; background:#0099FF; color:#FFFFFF ;font-size:28px">CONTENT3</a>
