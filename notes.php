	...
	<div id="page" class="site">
		...
		<Center>
			<div class="container" >
					...
					<Table border="0">
					<tr>
					<td><h2 class="top-heading"><center>SYLLABUS DOWNLOAD</h2><br>
					</td>
					</tr>
					<tr>
					<td>
					...
					<a href="unotes.php" style="padding:55px; background:#0099FF; color:#FFFFFF; font-size:28px">UG</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					
				 <a href="pnotes.php" style="padding:55px; background:#0099FF; color:#FFFFFF ;font-size:28px">PG</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
