	...
	<div id="page" class="site">
	 ...
	 <Center>
		...
		<br>
				 ...
				 <div style="float:right" ><a href="chatbot.php" style="padding:10px; background:#006699; color:#FFFFFF; font-size:16px">ENDOWMENT LECTURE</a></div>
				 <br>		
						<h2 class="top-heading">MOU  DETAILS</h2>
				  ...
				  <table border="1">
					<tr style="background:#FF3300; color:#FFFFFF; font-size:18px; font-weight:bold">
					 
		 <th>ID</th>  
        <th> ENDOWMENT LECTURE</th>  
		<th>CHIEF GUEST</th>
		<th>TITLE</th>	        
        <th>DATE</th>           
         ...
         <?php
$result=mysql_query("Select * from tb_end order by id");
