...
<body itemscope itemtype="http://schema.org/AboutPage">
	<div id="page" class="site">
	 ...
	 <Center>
		<div style="border:solid 0px; width:1200px">
		<br>
					 
					 
					 
					<Center>				
						<h2 class="top-heading" style="text-transform:uppercase">facilities</h2>
					 
					
					 <table border="1" width="90%">
					<tr style="background:#FF3300; color:#FFFFFF; font-size:24px; font-weight:bold">
					 				 
					<tr style="font-size:16px; color:#FFFFFF; font-weight:bold; text-transform:uppercase; background:#0066FF">
					 <td> COMPUTER LAB 1</td></tr>
					 <tr>
					 <td>
				<p style="font-size:18px;">
					
Computer labs facilitate hands-on learning, experimentation and innovation, making them an essential resource in educational institution. Labs are fully equipped with systems and latest software with an environment to implement and experiment knowledge acquired in the classroom. Systems are equipped with high bandwidth of internet. Trained and skilled lab faculties engage the students with practical sessions to help them navigate rapidly changing technology driven world. Students are flourished with projectors to aid audio visual learning.</p>
<center>
<img src="images/clab2.jpeg" width="500px">
		 	 </td>
	</tr>
	<tr style="font-size:16px; color:#FFFFFF; font-weight:bold; text-transform:uppercase; background:#0066FF">
					 <td> COMPUTER LAB2</td></tr>
					 <tr>
					 <td>
				<p style="font-size:18px;">
...
Computer labs facilitate hands-on learning, experimentation and innovation, making them an essential resource in educational institution. Labs are fully equipped with systems and latest software with an environment to implement and experiment knowledge acquired in the classroom. Systems are equipped with high bandwidth of internet. Trained and skilled lab faculties engage the students with practical sessions to help them navigate rapidly changing technology driven world. Students are flourished with projectors to aid audio visual learning.</p>
<center>
<img src="images/clab1.jpeg" width="500px">
		 	 </td>
	</tr> 
		  		</table>
